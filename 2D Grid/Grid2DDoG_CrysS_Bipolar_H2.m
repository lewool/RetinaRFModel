function Cell=Grid2DDoG_CrysS_Bipolar_H2(Em,Universe,thetas,SpatFreqs,SFLines,OriCircles)
%% GENERATE CELL
Cell=GenerateCell_CrysS_Bipolar_H2(Em);
...
if size(SCenterCoordsDeg,1)>=1 && sum(SCenterKernel)>0
