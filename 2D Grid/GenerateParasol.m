...
function Cell=GenerateParasol(Em)
%% GENERATE THE PATCH
...
%surround responses
CenterRadius=-0.000565*(Em^2)+(0.01863*Em)+0.00146; %In mm. Watanabe and Rodieck JCN 1989 Fig. 9
...
ConesToCenter=ceil(-2.6*(Em^2)+43.42*Em-4.342); %Computed as ConesPerMM*DFArea (as per Watanabe/Rodieck 1989 Fig 9), then fit. Good comparison to Goodchild et al., JCN 1996 Fig 7B
...
cSigma=max(CenterX); %(we assume 1 SD makes an RF radius)
