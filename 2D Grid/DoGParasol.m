function Parasol=DoGParasol(Em)
%% IMPORT DATA
Parasol=GenerateParasol_BipolarLayer(Em);

cpAll=Parasol.CenterWeights;
spAll=Parasol.SurroundWeights;
MaxCenterDistDeg=(Parasol.Center.Radius*1000)/200;
MaxSurroundDistDeg=(Parasol.Surround.Radius*1000)/200;
%% MODEL UNIVERSE
...
%Inherit the RF size from 'GenerateBipolarLayer.m'
SigmasToRFRadius=1; %Let's say that ~3 SDs make up a RF radius
CenterSigma=MaxCenterDistDeg/SigmasToRFRadius; %Here we assign a sigma for our cell given a particular eccentricity.
SurroundSigma=MaxSurroundDistDeg/SigmasToRFRadius; %Ditto.
CSStrengthRatio=.75;
...
Parasol.ChromTag=ChromTag;

Parasol.Convolution.DFRadiusDeg=MaxCenterDistDeg;
Parasol.Convolution.SpatialFrequencies=Freqs;

Parasol.Convolution.LResponse.CenterSigma=LcSigma;
Parasol.Convolution.LResponse.CenterAmplitude=crL;
Parasol.Convolution.LResponse.SurroundSigma=LsSigma;
Parasol.Convolution.LResponse.SurroundAmplitude=srL;

Parasol.Convolution.MResponse.CenterSigma=McSigma;
Parasol.Convolution.MResponse.CenterAmplitude=crM;
Parasol.Convolution.MResponse.SurroundSigma=MsSigma;
Parasol.Convolution.MResponse.SurroundAmplitude=srM;

Parasol.Convolution.SResponse.CenterSigma=ScSigma;
Parasol.Convolution.SResponse.CenterAmplitude=crS;
Parasol.Convolution.SResponse.SurroundSigma=SsSigma;
Parasol.Convolution.SResponse.SurroundAmplitude=srS;

Parasol.ResponseFunctions.LIsoResponse.Amplitude=TotalLData.Amplitude;
Parasol.ResponseFunctions.LIsoResponse.Phase=TotalLData.Phase;
Parasol.ResponseFunctions.MIsoResponse.Amplitude=TotalMData.Amplitude;
Parasol.ResponseFunctions.MIsoResponse.Phase=TotalMData.Phase;
Parasol.ResponseFunctions.LMSumResponse.Amplitude=TotalData.Amplitude;
Parasol.ResponseFunctions.LMSumResponse.Phase=TotalData.Phase;
Parasol.ResponseFunctions.LMDiffResponse.Amplitude=LMDiffData.Amplitude;
Parasol.ResponseFunctions.LMDiffResponse.Phase=LMDiffData.Phase;
