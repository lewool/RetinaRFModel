function Cell=Grid2DDoG_CrysS(Em,Universe,thetas,SpatFreqs,SFLines,OriCircles)
%% GENERATE CELL
Cell=GenerateCell_CrysS(Em);
...
SCenterKernel=(~isnan(Cell.Center.SCones.Coords(:,1))).*(Cell.Center.CenterKernel);
...
SSurroundKernel=(~isnan(Cell.Surround.SCones.Coords(:,1))).*(Cell.Surround.SurroundKernel);
